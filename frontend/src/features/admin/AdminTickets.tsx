...
import { shareTicketOnWhatsApp } from '../../utils/whatsappService';
            ...
            <div className="bg-primary-500 text-white p-4 flex items-center justify-between dark:bg-primary-600">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  title="Send Ticket Update via WhatsApp"
                  className="p-1.5 rounded-lg bg-green-400/20 hover:bg-green-400/40 transition-all text-white"
                >
